...
async def batch_repo_subflow(
    ...
    if strategy.on_completion_hooks:
        single_repo_flow = process_single_repo_flow.with_options(
            on_completion=strategy.on_completion_hooks
        )
    else:
        single_repo_flow = process_single_repo_flow
