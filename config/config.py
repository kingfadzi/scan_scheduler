...
class Config:
    ...
    DEFAULT_PROCESSING_BATCH_SIZE = int(os.getenv("PROCESSING_BATCH_SIZE", 10))
    DEFAULT_PROCESSING_BATCH_WORKERS = int(os.getenv("PROCESSING_BATCH_WORKERS", 2))
    DEFAULT_PER_BATCH_WORKERS = int(os.getenv("PER_BATCH_WORKERS", 5))
    DEFAULT_TASK_CONCURRENCY = int(os.getenv("TASK_CONCURRENCY", 3))
